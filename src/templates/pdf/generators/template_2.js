/**
 * Template 2 PDF Generator - Modern Template
 *
 * Generates PDF documents for Template 2 using jsPDF
...
class Template2Generator {
    ...
    generate(data) {
        ...
        // Generate document sections (same as Template 1 for now)
        this.addCoverPage();
        this.addJobOverview();
