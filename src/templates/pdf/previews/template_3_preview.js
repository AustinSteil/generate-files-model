/**
 * Template 3 HTML Preview Generator - Minimal Template
 *
 * Generates HTML preview for Template 3 that mirrors the PDF layout
...
class Template3Preview {
    static generate(data) {
        return `
            <div class="preview-content">
                <div class="preview-header">
                    <h2>Job Analysis Report</h2>
                    <p class="preview-subtitle">Minimal Template Design</p>
                </div>
...
window.Template3Preview = Template3Preview;
console.log('✅ Template3Preview class loaded and exposed to window');
