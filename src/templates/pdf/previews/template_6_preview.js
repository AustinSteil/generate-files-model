/**
 * Template 6 HTML Preview Generator - Executive Summary Template
 *
 * Generates HTML preview for Template 6 that mirrors the PDF layout
 * Executive summary focused layout with key highlights
 *
 * @author Austin Steil
 * @version 1.0.0
...
class Template6Preview {
    static generate(data) {
        return `
            <div class="preview-content">
                <div class="preview-header">
                    <h2>Job Analysis Report</h2>
                    <p class="preview-subtitle">Executive Summary Template Design</p>
                </div>
...
window.Template6Preview = Template6Preview;
console.log('✅ Template6Preview class loaded and exposed to window');
