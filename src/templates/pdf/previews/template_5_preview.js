/**
 * Template 5 HTML Preview Generator - Detailed Template
 *
 * Generates HTML preview for Template 5 that mirrors the PDF layout
 * Comprehensive detailed layout with extensive information
 *
 * @author Austin Steil
 * @version 1.0.0
...
class Template5Preview {
    static generate(data) {
        return `
            <div class="preview-content">
                <div class="preview-header">
                    <h2>Job Analysis Report</h2>
                    <p class="preview-subtitle">Detailed Template Design</p>
                </div>
...
window.Template5Preview = Template5Preview;
console.log('✅ Template5Preview class loaded and exposed to window');
